 ...
 */
public class OscalDay2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // This fragment uses the same layout as day1
        ...
        mViewPager.setAdapter(new DayFragmentsAdapter(getChildFragmentManager(),2));
