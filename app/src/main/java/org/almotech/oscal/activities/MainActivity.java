...
*/
    ...
    public static class OrganizersFragment extends DialogFragment {
    ...
    public static class ContactFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            Dialog mDialog =  new AlertDialog.Builder(context)
                    .setTitle(title)
                    .setMessage(getResources().getText(R.string.contact_text))
                    .setPositiveButton(android.R.string.ok, null).create();
            return mDialog;
        }
